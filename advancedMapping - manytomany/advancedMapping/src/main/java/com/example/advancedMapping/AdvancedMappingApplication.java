...
public class AdvancedMappingApplication {
	...
	private void updateStudent(AppDAO appDAO) {
		int id=1;
		Student student=appDAO.findStudentAndCourses(1);
		student.setEmail("baara@gmail.com");
		student.addCourse(new Course("How to sleep at training"));
	...
	private void createStudentAndCourse(AppDAO appDAO) {
		...
		Student student=new Student("aya","aya@gmail.com","baara");
